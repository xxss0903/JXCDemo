...
--
-- Table structure for table `goodsback`
--
...
CREATE TABLE `goodsback` (
  ...
  `g_bz` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`g_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `goodsback`
--

LOCK TABLES `goodsback` WRITE;
/*!40000 ALTER TABLE `goodsback` DISABLE KEYS */;
INSERT INTO `goodsback` VALUES (3,'2019-01-05 00:00:00','admin',NULL,NULL,'退回产品');
/*!40000 ALTER TABLE `goodsback` ENABLE KEYS */;
UNLOCK TABLES;
