...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <c:forEach items="${result}" var="sendpage">
        <tr>
            <td align="center"><a href="sendpage_print.do?sendpageid=${sendpage.sId}">${sendpage.sTitle}</a></td>
            ...
            <td align="center"><a href="/sendpage_edit.do?sendpageid=${sendpage.sId }" ><img src="images/user_edit.png" title="" border="0" /></a></td>
            <td align="center"><a href="/sendpage_delete.do?sendpageid=${sendpage.sId}" class="ask"><img src="images/trash.png" title="" border="0" /></a></td>
        </tr>
    </c:forEach>
</table>
